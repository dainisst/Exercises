...
public class Array1
{
    ...
    {
        int[] numsRev = { nums[2], nums[1], nums[0] };
    ...
    {
        int[] numN = { nums[0], nums[nums.Length - 1] };
    ...
    public bool Double23(int[] nums)
    {
        ...
        if ((nums[0] == 2 || nums[0] == 3) && nums[0] == nums[1])
        {
            return true;
        }
    ...
    public int[] MakeMiddle(int[] nums)
    {
        ...
        if (leng > 2)
        {
            int[] numsNew = {nums[lengDiv - 1], nums[lengDiv]};
            return numsNew;
        }
